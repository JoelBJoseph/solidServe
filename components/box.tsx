...
const Box: NextPage<BoxType> = ({ onSolidServeTextClick }) => {
  return (
    <header className="self-stretch flex flex-row items-center justify-start max-w-full text-left text-[1.21rem] text-black font-inter">
      <div className="w-[80rem] flex flex-row items-center justify-between py-[0.89rem] pr-[1.56rem] pl-[16.22rem] box-border relative gap-[1.11rem] max-w-full mq450:pl-[1.11rem] mq450:box-border mq950:pl-[8.11rem] mq950:box-border">
      ...
      <h1
        className="m-0 h-[1.78rem] w-[8.94rem] relative text-[1.67rem] tracking-[0.1px] leading-[1.78rem] font-bold font-h6 inline-block whitespace-nowrap cursor-pointer z-[2] ml-[-1409px]"
