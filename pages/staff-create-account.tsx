...
const StaffCreateAccount: NextPage = () => {
  return (
    <div className="w-full relative bg-ghostwhite overflow-hidden flex flex-col items-center justify-start pt-[3rem] pb-[8.44rem] pr-[25rem] pl-[2.67rem] box-border gap-[8.17rem] tracking-[normal] text-left text-[2.67rem] text-black font-roboto-flex mq450:gap-[2.06rem] mq450:pr-[1.11rem] mq450:box-border mq950:gap-[4.06rem] mq950:pl-[1.33rem] mq950:pr-[12.5rem] mq950:box-border">
