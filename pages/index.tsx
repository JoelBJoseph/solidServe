...
const EInbox: NextPage = () => {
  const [frameInputTextValue, setFrameInputTextValue] = useState("");
  ...
  const onAvatarFrameLine1Click = useCallback(() => {
    router.push("/");
  }, [router]);

  const onButtonPrimaryContainer2Click = useCallback(() => {
    router.push("/e-all-customers");
  }, [router]);

  const onLineSeparatorClick = useCallback(() => {
    ...
    <div className="w-full relative bg-ghostwhite overflow-hidden flex flex-col items-start justify-start tracking-[normal]">
      ...
      <main className="w-[78.89rem] flex flex-row items-start justify-start py-[0rem] pr-[1.11rem] pl-[0rem] box-border gap-[2.22rem] max-w-full mq950:gap-[1.11rem] mq950:pl-[1.11rem] mq950:box-border">
        <ENavigation1
          ...
          general01Icons02Common6="/00-general--01-icons--02-common--02-user-1@2x.png"
          ...
          nameBackgroundColor="#1e5eff"
          typeColor="#fff"
          propBackgroundColor="#f5f6fa"
          propColor="#717899"
          onInstanceFrameContainerClick={onButtonPrimaryContainerClick}
          onNameFieldContainer1Click={onAvatarFrameLine1Click}
          onInstanceFrameContainer2Click={onButtonPrimaryContainer2Click}
          onProfileImageFrameClick={onLineSeparatorClick}
          onIconAlternateSignOutClick={onIconAlternateSignOutClick}
          onFrameDropdownFieldTypeClick={onFrameContainerClick}
        ...
        <section className="flex-1 flex flex-col items-start justify-start pt-[1.56rem] px-[0rem] pb-[0rem] box-border max-w-[calc(100%_-_290px)] text-left text-[1.33rem] text-gray-300 font-inter mq950:max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[1.56rem] max-w-full">
            ...
            <div className="self-stretch rounded-md bg-light-text-color shadow-[0px_1px_4px_rgba(21,_34,_50,_0.08)] overflow-hidden flex flex-row items-start justify-start pt-[1.56rem] px-[0rem] pb-[0.89rem] box-border relative max-w-full [row-gap:20px] text-[0.78rem] mq950:flex-wrap mq950:pt-[1.11rem] mq950:pb-[1.11rem] mq950:box-border">
              ...
              <div className="w-[19.44rem] flex flex-col items-center justify-start gap-[2.67rem] min-w-[19.44rem] max-w-full mq450:gap-[1.33rem] mq450:min-w-full mq950:flex-1">
                <div className="w-[18.5rem] flex flex-col items-start justify-start py-[0rem] px-[1.11rem] box-border gap-[1.33rem] max-w-full text-[0.89rem]">
                  ...
                  <div className="self-stretch flex flex-row items-end justify-end pt-[1.78rem] pb-[0rem] pr-[0.89rem] pl-[2.67rem] relative z-[1] text-[0.78rem] text-slategray-400 mq450:pl-[1.11rem] mq450:box-border">
                    ...
                    <div className="h-full w-full absolute my-0 mx-[!important] right-[0rem] bottom-[-1.33rem] left-[0rem] rounded bg-light-text-color box-border z-[1] border-[1px] border-solid border-lavender-200" />
                    <input
                      ...
                      placeholder="Search..."
                      type="text"
                      value={frameInputTextValue}
                      onChange={(event) =>
                        setFrameInputTextValue(event.target.value)
                      }
                    />
                    <img
              ...
              <div className="flex-1 flex flex-col items-center justify-start gap-[10.56rem] min-w-[27.44rem] max-w-full text-[0.89rem] mq450:gap-[2.61rem] mq700:min-w-full mq950:gap-[5.28rem]">
                <div className="w-[41.33rem] flex flex-col items-end justify-start py-[0rem] px-[1.11rem] box-border gap-[1.56rem] max-w-full">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[1.33rem]">
                    <div className="self-stretch flex flex-row items-start justify-between gap-[1.11rem] mq450:flex-wrap">
                      <div className="flex flex-row items-center justify-start gap-[0.22rem]">
                        <b className="h-[1.33rem] w-[5.44rem] relative leading-[1.33rem] inline-block z-[1]">
                          Luis Pittman
                        </b>
                  ...
                  <ChatBubble
                    ...
                    avatar1="12:24 AM"
                    propPadding="0.67rem 0.72rem 0.67rem 0.67rem"
                    propWidth="25.33rem"
                  />
                  <FrameZ avatar="36x36x-122659167" />
                  <div className="self-stretch flex flex-row items-start justify-start max-w-full text-[0.78rem] text-light-text-color">
                    <div className="flex flex-row items-start justify-start gap-[0.89rem] max-w-full mq700:flex-wrap">
                      ...
                      <div className="flex flex-col items-start justify-start gap-[0.44rem] max-w-full">
                        <div className="rounded bg-mediumslateblue flex flex-row items-center justify-center p-[0.67rem] box-border whitespace-nowrap max-w-full z-[1]">
                          <div className="h-[2.44rem] w-[27.28rem] relative rounded bg-mediumslateblue hidden max-w-full" />
                          <div className="h-[1.11rem] w-[25.94rem] relative leading-[1.11rem] inline-block z-[2]">
                            Sure, I want to know when the new spring collection
                            for men is coming
                          </div>
                        </div>
                        <div className="w-[4.44rem] flex flex-row items-start justify-start relative text-[0.67rem] text-lightsteelblue">
                          <div className="h-[0.89rem] flex-1 relative leading-[0.89rem] inline-block whitespace-nowrap z-[1]">
                            12:35 AM
                          </div>
                          <img
                            className="h-[1.33rem] w-[1.33rem] absolute my-0 mx-[!important] top-[-0.72rem] left-[-0.67rem] overflow-hidden shrink-0 z-[3]"
                            alt=""
                          />
                        </div>
                      </div>
