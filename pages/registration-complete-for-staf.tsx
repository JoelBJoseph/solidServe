...
import ResetPassword2 from "../components/reset-password2";

const RegistrationCompleteForStaf: NextPage = () => {
  return (
    <div className="w-full relative bg-ghostwhite overflow-hidden flex flex-col items-center justify-start pt-[2.89rem] pb-[14.33rem] pr-[25rem] pl-[3.06rem] box-border gap-[8.5rem] tracking-[normal] text-left text-[2.67rem] text-black font-roboto-flex mq450:gap-[2.11rem] mq450:pr-[1.11rem] mq450:box-border mq950:gap-[4.22rem] mq950:pl-[1.5rem] mq950:pr-[12.5rem] mq950:box-border">
...
export default RegistrationCompleteForStaf;
